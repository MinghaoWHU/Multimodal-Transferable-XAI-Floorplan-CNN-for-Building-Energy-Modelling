...
EFFICIENTNET_CKPT = "checkpoints/plan_zichuang_efficientnet/EfficientNet_best.pth"

# 输出目录
OUTPUT_DIR = "efficientnet_test_results"

# EfficientNet 模型参数，需要和训练时一致
...
def plot_prediction_scatter(
    ...
    split_name: str,
    output_dir: Path,
    model_name: str = "MultimodalEfficientNet",
) -> None:
    """
    绘制预测值-真实值对照散点图。
    包含：
...
def main() -> None:
    ...
    efficientnet_model = MultimodalEfficientNetRegressor(
    ...
    all_results = evaluate_efficientnet_model(
    ...
    summary_path = output_dir / "efficientnet_metrics_summary.csv"
